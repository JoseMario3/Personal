    ...
    <div className={styles.main}>
      <div className={styles.inner}>
        ...
        <p className={styles.p}>
          ...
          Octopath Traveler 0, I am regrettably behind the times and haven’t
          gotten to play it yet. I’m slowly catching up, however, and I want to
          talk about its predecessor instead: Octopath Traveler 2. I had been
          excited to play it ever since it was announced in 2022, and even more
          encouraged after seeing all the great reviews it received. Despite my
          eagerness, I was well-aware that this game would be a massive JRPG
          that I’d need to make time for. With so many other games already in my
          backlog, I wasn’t in a rush to play it. With that in mind, I left the
          game in my wishlist, keeping an eye out for any good sales. The stars
          aligned earlier this year, however, when I finally found a fantastic
          sale on the game and hit purchase. Despite a still-long list of games
          I wanted to beat in 2025, I managed to put 65 hours into it. Before I
          get into my full thoughts on Octopath Traveler 2, I want to talk about
          my experience with the original game, Octopath Traveler.
        </p>
        <p className={styles.p}>
        ...
        <p className={styles.p}>
          ...
          of my favorite parts of the game. Throné’s steal ability is one of my
          favorites. Every NPC in town has items on them, and you have a percent
          chance of stealing it from them depending on how rare the item is. You
          can also use Partitio’s purchase ability to simply buy items off a
          person, but I prefer to gamble on chance. I’m not convinced that the
          stealing percentages are accurate (I’ve failed an 80% chance too many
          times), but I need to do more research into it. The rest of the
          abilities from the first game all return, but new abilities are
          introduced as well thanks to the brand new day/night cycle. The
          day/night cycle made each town even more involved than the first game.
          Every character now has different abilities depending on the time of
          day. In addition to Osvald’s daytime ability to scrutinize NPCs, at
          night he’s also able to mug NPCs – challenge them in combat to take
          their belongings. These new abilities come on a spectrum from ‘always
          useful’ to ‘quest specific.’ For example, I would use Agnea’s entreat
          ability every chance I got to receive useful items from NPCs, but I
          would only use Temenos’s coerce ability when absolutely necessary. The
          minor overlap in some characters’ abilities urged me to think twice
          about how I approached every person in the town. Is it worth it to
          spend 10,000 leaves for Hikari to bribe info out of a character, or is
          there a chance Castti can inquire from them for free? Several of the
          playable characters are also able to summon NPCs to aid in battle,
          whether it be through the guide, befriend, allure, or hire abilities.
          Each town comes with a few sidequests to optionally complete, and they
          usually require using one of the characters’ abilities to solve a
          problem. From completing sidequests to using abilities on NPCs,
          shopping, and unlocking hidden chests, there was a plethora of things
          to do in every town before I even commenced a chapter.
        </p>
        ...
        <p className={styles.p}>
          ...
          have been tweaked. One of the biggest reworks is Castti’s concoct
          skill. In OT, Alfyn had access to dozens of herbs and was able to
          attack using every element, making him extremely overpowered with so
          many options to choose from. In OT2, Castti only has access to Wind,
          Light, and Dark elements, with a bigger emphasis on buffs/debuffs
          during battle. I think it was a good move to nerf the apothecary
          skill, while also giving her lots of synergy with other party members.
          Throné and Temenos both have nighttime-specific abilities, buffing the
          party and debuffing enemies respectively. Osvald’s Scholar ability to
          view one of an enemy’s weaknesses reigns supreme at the start of
          combat. The summon abilities are cute sometimes, but I usually would
          rather use a regular attack than spend a turn calling an NPC. This is
          not to be confused with Ochette’s Pokémon-esque capture ability that
          is still a lot of fun. OT2 introduces a fully new mechanic called
          Latent Power. Every character is given their own latent power that can
          be used once charged. I won’t list them all here, but some of my
          favorites are Throné’s power to immediately get a second turn and
          Partitio’s power to instantly receive max BP. My least favorite of the
          latent powers is probably Agnea’s power to make single target attacks
          hit all enemies, only because it isn’t as relevant during boss battles
          with a single target. These latent powers add another layer of
          complexity to an already involved combat system and make each battle
          even more engaging.
        </p>
        <p className={styles.p}>
        ...
        <p className={styles.p}>
          ...
          Legends/Hope/etc.” These motifs are also used in their final boss
          themes, aptly named “The Journey for Freedom/Truth/etc Ends.” I get a
          burst of serotonin every time I hear their motifs in the endgame. I
          could go on and on talking about my favorite tracks from this game,
          but I’ll finish here by saying my current top 3 songs from OT2 are
          Song of Hope, Critical Clash II, and Those Who Deny the Dawn.
        </p>
        <h2 className={styles.h2}>Traveling Together</h2>
        <p className={styles.p}>
          I’m super happy that this game gives more attention to the
          interactions between the travelers. In the first game, the eight
          travelers didn’t interact at all outside of combat; it was as if they
          were total strangers traveling together for unclear reasons. The cast
          is much more tight-knit in this game. All the party members have
          one-on-one conversations about various things in each other’s
          chapters, and there’s extra conversations between three party members
          in the taverns. I loved watching them connect with each other in these
          heart-to-hearts and learn a new perspective from the other person. OT2
          also has tag-team chapters where Hikari/Agnea, Osvald/Partitio,
          Throné/Temenos, and Ochette/Castti work together to delve into the
          mysteries of Solistia, giving them even more opportunities to bond
          with each other. This all culminates in a final quest after you
          complete everyone’s stories called “The Journey for the Dawn.” In this
          segment, the entire world is covered in darkness, and you’re no longer
          able to switch to daytime. The entire party comes together as one team
          to discover how this happened and defeat the wicked god, Vide once and
          for all. The final battle rivals the first game’s true final boss in
          difficulty and is probably the most invigorating boss fight in the
          game. Sadly, I have yet to defeat this final boss, but rest assured I
          fully intend to return and see it through to the end.
        </p>
